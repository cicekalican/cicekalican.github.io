...
More recently, I have been extending my research toward large language models. I am particularly interested in how LLMs represent, learn, and violate morphosyntactic and discourse-pragmatic constraints, and how experimentally grounded linguistic data can support model evaluation, fine-tuning, and error analysis. In this context, I am currently working on a pipeline that integrates experimental workflows and transforms linguistic experimental data into structured resources for LLM training and evaluation.

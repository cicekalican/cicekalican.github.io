...
My research focuses primarily on English, Turkish and with German on the periphery. I combine formal analysis with experimental methods to investigate how grammatical structure shapes interpretation, processing, and acceptability judgments.
...
More recently, I have been extending my research toward large language models. I am particularly interested in how LLMs represent, learn, and violate intra- and extra-linguistic constraints, and how experimentally grounded linguistic data can support model evaluation, fine-tuning, and error analysis. In this context, I am currently developing [negatif.io](https://negatif.io/), a pipeline for converting experimental data into structured resources for LLM training and evaluation.

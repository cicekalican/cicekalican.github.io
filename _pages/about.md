...
More recently, I have been extending my research toward large language models. I am particularly interested in how LLMs represent, learn, and violate morphosyntactic and discourse-pragmatic constraints, and how experimentally grounded linguistic data can support model evaluation, fine-tuning, and error analysis. In this context, I am currently working on a pipeline to combine the steps of experimenting and to convert experimental linguistic data into structured resources for LLM training and evaluation. 
